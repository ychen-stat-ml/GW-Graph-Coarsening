...
parser.add_argument('--alm', type=str, default="",
            help='whether use agglomerative hierarchical clustering for wgc')
...
print(args.method, args.dataset, args.seed)
...
if args.alm:
    dataset = explog.read_from("./data/molecules/{}_{}_{}_{}.pkl".
        format(args.dataset, args.method, args.alm, args.seed))
elif args.method:
    dataset = explog.read_from("./data/molecules/{}_{}_{}.pkl".
                                format(args.dataset, args.method, args.seed))
else:
